                ...
                <div class="col">
                    <div class="card text-white bg-dark mb-3 border-0" >
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://fyp6men.herokuapp.com/salesForecasting/link_page_forecast.html" class="btn btn-outline-light" onclick="setGeo()">Lets go</a>
                        </div>
                ...
                <div class="col">
                    <div class="card text-white bg-dark mb-3 border-0" >
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://fyp6men.herokuapp.com/link_page_customer.html" class="btn btn-outline-light" onclick="setGeo()">Lets go</a>
                        </div>
